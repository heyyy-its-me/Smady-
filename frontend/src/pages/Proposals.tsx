...
import { Send, Clock, CheckCircle2, Eye, Check, X, AlertTriangle, Search, RefreshCw, ChevronDown, ChevronUp, Package } from "lucide-react";
...
export default function Proposals() {
  ...
  return (
    <div data-testid="proposals-page">
      ...
      {/* Pricing packages — show if available */}
      {pricingPackages.length > 0 && (
        <div className="mb-5 flex flex-wrap gap-2" data-testid="pricing-packages">
          {pricingPackages.map((pkg) => (
            <div key={pkg.id} className="rounded-xl border border-border bg-surface px-4 py-2.5 shadow-card">
